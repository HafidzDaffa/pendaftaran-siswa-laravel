...
<body class="w-full h-screen bg-background flex flex-col">
    ...
    <div class="items-center flex flex-col py-[40px] px-[55px] gap-y-[80px] pb-[400px]">
        <div class="flex justify-center flex-col bg-primary gap-y-[56px] w-[60%] h-[396px] rounded-2xl items-center text-[24px]">
            ...
            <a href="/register" class="bg-secondary rounded-lg px-[51px] py-[14px] text-[18px] text-white font-bold hover:bg-sky-700 transition-all duration-300">Lengkapi Data</a>
        </div>
    </div>
